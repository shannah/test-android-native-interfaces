 ...
 * @author Shai Almog
 */
public class AndroidNativeTestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "AndroidNativeTest";
    ...
    private AndroidNativeTest mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new AndroidNativeTestStub());
    }
